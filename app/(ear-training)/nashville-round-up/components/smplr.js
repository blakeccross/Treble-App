...
var Channel = class {
  constructor(context, options) {
    ...
    __privateSet(this, _disconnect, connectSerial([this.input, __privateGet(this, _volume), __privateGet(this, _config).destination]));
    const volume = createControl(__privateGet(this, _config).volume);
    this.setVolume = volume.set;
    __privateSet(
      this,
      _unsubscribe,
      volume.subscribe((volume2) => {
  ...
  addInsert(effect) {
    ...
    __privateSet(
      this,
      _disconnect,
      connectSerial([this.input, ...__privateGet(this, _inserts), __privateGet(this, _volume), __privateGet(this, _config).destination])
    );
  }
...
var SortedQueue = class {
  ...
  removeAll(predicate) {
    ...
    __privateSet(
      this,
      _items,
      __privateGet(this, _items).filter((item) => !predicate(item))
    );
...
var QueuedPlayer = class {
  ...
  stop(sample) {
    ...
    if (stopId) {
      __privateGet(this, _queue).removeAll((item) => (item.time >= time && item.stopId ? item.stopId === stopId : item.note === stopId));
    } else {
...
var SamplePlayer = class {
  ...
  start(sample) {
    ...
    const cleanup = unsubscribeAll([
      connectSerial([source, lpf, volume, decay, gainCompensation, __privateGet(this, _config3).destination]),
...
var DefaultPlayer = class {
  constructor(context, options) {
    ...
    this.player = new QueuedPlayer(new SamplePlayer(context, __spreadProps(__spreadValues({}, options), { destination: channel.input })), options);
    this.output = channel;
  }
  get buffers() {
    return this.player.buffers;
  ...
  stop(sample) {
    this.player.stop(typeof sample === "object" ? sample : sample !== void 0 ? { stopId: sample } : void 0);
  }
  disconnect() {
...
var DrumMachine = class {
  ...
  start(sample) {
    ...
    return this.player.start(
      __spreadProps(__spreadValues({}, sample), {
...
function findSamplesInRegions(group, sample, seqNumber, options) {
  ...
  for (const region of group.regions) {
    const found = findSampleInRegion(midi, seqNumber != null ? seqNumber : 0, sample, region, options);
...
function findSampleInRegion(midi, seqNum, sample, region, defaults) {
  ...
  const matchVelocity =
    sample.velocity === void 0 ||
    (sample.velocity >= ((_c = region.velLow) != null ? _c : 0) && sample.velocity <= ((_d = region.velHigh) != null ? _d : 127));
  ...
  return {
    decayTime:
      (_l = (_k = sample == null ? void 0 : sample.decayTime) != null ? _k : (_j = region.sample) == null ? void 0 : _j.decayTime) != null
        ? _l
        : defaults == null
        ? void 0
        : defaults.decayTime,
    ...
    duration:
      (_p = (_o = sample == null ? void 0 : sample.duration) != null ? _o : (_n = region.sample) == null ? void 0 : _n.duration) != null
        ? _p
        : defaults == null
        ? void 0
        : defaults.duration,
    ...
    loop:
      (_s = (_r = sample == null ? void 0 : sample.loop) != null ? _r : (_q = region.sample) == null ? void 0 : _q.loop) != null
        ? _s
        : defaults == null
        ? void 0
        : defaults.loop,
    loopEnd:
      (_v = (_u = sample == null ? void 0 : sample.loopEnd) != null ? _u : (_t = region.sample) == null ? void 0 : _t.loopEnd) != null
        ? _v
        : defaults == null
        ? void 0
        : defaults.loopEnd,
    loopStart:
      (_y = (_x = sample == null ? void 0 : sample.loopStart) != null ? _x : (_w = region.sample) == null ? void 0 : _w.loopStart) != null
        ? _y
        : defaults == null
        ? void 0
        : defaults.loopStart,
    lpfCutoffHz:
      (_B = (_A = sample == null ? void 0 : sample.lpfCutoffHz) != null ? _A : (_z = region.sample) == null ? void 0 : _z.lpfCutoffHz) != null
        ? _B
        : defaults == null
        ? void 0
...
function SfzInstrumentLoader2(url, config) {
  ...
  return (context, storage) =>
    __async(this, null, function* () {
      ...
      return Promise.all(
        Array.from(sampleNames).map((sampleName) =>
          __async(this, null, function* () {
...
var Scope = class {
  ...
  closeScope(mode, group) {
    if (mode === "global") {
      ...
      const region = __privateMethod(this, _Scope_instances, closeRegion_fn).call(
        this,
        __spreadValues(
          __spreadValues(
            {
...
var Versilian = class {
  constructor(context, options = {}) {
    ...
    const loader = VcslInstrumentLoader(this.config.instrument, this.player.buffers);
...
var Mellotron = class {
  ...
  start(sample) {
    const found = findFirstSampleInRegions(this.group, typeof sample === "object" ? sample : { note: sample }, void 0, this.options);
...
var Reverb = class {
  constructor(context) {
    ...
    __privateSet(
      this,
      _ready,
      createDattorroReverbEffect(context).then((reverb) => {
...
var Sampler = class {
  constructor(context, options = {}) {
    ...
    const loader =
      typeof __privateGet(this, _options).buffers === "function"
        ? __privateGet(this, _options).buffers
        : createAudioBuffersLoader(__privateGet(this, _options).buffers, storage);
  ...
  start(sample) {
    return this.player.start(typeof sample === "object" ? sample : { note: sample });
  }
  stop(sample) {
    return this.player.stop(typeof sample === "object" ? sample : sample === void 0 ? void 0 : { stopId: sample });
  }
  disconnect() {
...
var Smolken = class {
  ...
  start(sample) {
    const found = findSamplesInRegions(this.group, typeof sample === "object" ? sample : { note: sample }, this.seqNum);
    this.seqNum++;
...
var Soundfont = class {
  ...
  start(sample) {
    const found = findFirstSampleInRegions(this.group, typeof sample === "object" ? sample : { note: sample });
    if (!found) return () => void 0;
    return this.player.start(found);
  }
  stop(sample) {
...
function soundfontLoader(url, loopsUrl, buffers, group) {
  ...
  return (context, storage) =>
    __async(this, null, function* () {
      const [_, loops] = yield Promise.all([loadInstrument(context, storage), fetchSoundfontLoopData(loopsUrl)]);
      if (loops) {
...
var Soundfont2Sampler = class {
    ...
    this.load = loadSoundfont(options)
      .then((soundfont) => {
        ...
        __privateSet(
          this,
          _instrumentNames,
          soundfont.instruments.map((instrument) => instrument.header.name)
        );
      })
      .then(() => this);
  }
  ...
  loadInstrument(instrumentName) {
    var _a, _b, _c;
    const sf2instrument = (_a = this.soundfont) == null ? void 0 : _a.instruments.find((inst) => inst.header.name === instrumentName);
...
var SplendidGrandPiano = class {
  ...
  stop(sample) {
    ...
    if (typeof sample === "string") {
      ...
      return this.player.stop(midi !== void 0 ? __spreadProps(__spreadValues({}, sample), { stopId: midi }) : sample);
    } else {
      return this.player.stop(sample);
    }
  }
...
function splendidGrandPianoLoader(baseUrl, storage, notesToLoad) {
  ...
  let layers = notesToLoad
    ? LAYERS.filter((layer) => layer.vel_range[0] <= notesToLoad.velocityRange[1] && layer.vel_range[1] >= notesToLoad.velocityRange[0])
    : LAYERS;
  return (context, buffers) =>
    __async(this, null, function* () {
      for (const layer of layers) {
        ...
        yield Promise.all(
          samples.map((_0) =>
            __async(this, [_0], function* ([midi, name]) {
