    ...
    <Svg width={"100%"} height={"100%"} style={{ backgroundColor: color1 }}>
      <Defs>
        <Pattern id="diagonalPattern" width={size} height={size} patternUnits="userSpaceOnUse">
          <Line opacity={0.4} x1={(size / 2) * -1} x2={size / 2} y1={size / 2} y2={(size / 2) * -1} stroke={color2} strokeWidth={strokeWidth} />
          <Line opacity={0.4} x1={0} x2={size} y1={size} y2={0} stroke={color2} strokeWidth={strokeWidth} />
          <Line opacity={0.4} x1={size / 2} x2={size + size / 2} y1={size + size / 2} y2={size / 2} stroke={color2} strokeWidth={strokeWidth} />
        </Pattern>
      </Defs>
