...
export const SkeletonLoader = ({
    ...
    */
    ...
    translatex.value = withRepeat(
      withDelay(
        ...
        withTiming(direction === ANIMATION_DIRECTION.leftToRight ? rightMostEnd : leftMostEnd, {
          duration: 500,
  ...
  const animateAcrossYDirection = () => {
    ...
    */
    ...
    translatey.value = direction === ANIMATION_DIRECTION.topToBottom ? topMostEnd : bottomMostEnd;
    translatey.value = withRepeat(
      withDelay(
        800, //Delay before the next iteration of animation starts
        withTiming(direction === ANIMATION_DIRECTION.topToBottom ? bottomMostEnd : topMostEnd, {
          duration: 500,
          easing: Easing.linear,
        })
      ),
  ...
  return (
    <Animated.View
      onLayout={(event) => {
        if (parentDimensions.height === -1 && parentDimensions.width === -1 && animationType === ANIMATION_TYPE.shiver) {
      ...
      style={[styles.itemParent, { height, width, backgroundColor }, style, animatedStyleParent]}
    >
      {animationType === ANIMATION_TYPE.shiver ? (
        <Animated.View
          onLayout={(event) => {
