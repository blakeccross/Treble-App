import { Adapt, FontSizeTokens, H1, Paragraph, Select, SelectProps, Sheet, XStack, YStack, getFontSize } from "tamagui";
import { LinearGradient } from "tamagui/linear-gradient";
import { useMemo, useState } from "react";
import { Book, Check, ChevronDown, ChevronUp } from "@tamagui/lucide-icons";
...
export function Dropdown({ title, data, ...props }: DropdownProps) {
  return (
    <Select disablePreventBodyScroll {...props}>
      <Select.Trigger iconAfter={ChevronDown}>
        ...
        {/* <Select.Value placeholder={<H1>HELLO</H1>} /> */}
      </Select.Trigger>
